...
export default class Tutorial extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      tuto: [{url: Imagen.tuto1},{url: Imagen.tuto2},{url: Imagen.tuto3},{url: Imagen.tuto4}],
    };
  }
      ...
      <Container>
          <Content contentContainerStyle={{ justifyContent: 'center', flex: 1}}>
            ...
            <View style={{position: 'absolute',bottom: 50,left: 0,right: 0,justifyContent: 'center',alignItems: 'center',flexDirection: 'row',backgroundColor: 'transparent'}}>
              {this.state.tutorial === '3' && 
              <Button disabled={this.state.tutorial !== '3'} style={{borderRadius:25,backgroundColor:this.state.tutorial === '3'?COLOR.verde:COLOR.gris,alignSelf:'center'}} onPress={() => {this._storeData(); (!this.props.data?toastr.showToast('Ha iniciado sesión!','success'):null); this.props.handler(1,this.props.token);} }>
