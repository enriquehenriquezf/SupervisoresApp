        ...
        {this.state.isPrivacidad &&
          ...
          >
            <View style={{justifyContent:'space-between', width:"100%", height:"100%"}}>
              ...
              <WebView style={{width:"100%"}} scrollEnabled={false} source={{html: this.state.politicas[this.state.privacidad]}}/>
