...
import {View, Dimensions, KeyboardAvoidingView, AsyncStorage, Platform, Image,AppState, Alert,ScrollView } from 'react-native';
        ...
        >
          <View style={{justifyContent:'space-between', width:"100%"}}>
            ...
            <View style={{flexDirection:'row', justifyContent:'space-between'}}>
              <Button disabled={this.state.privacidad !== ''+(this.state.politicas.length-1)} style={{backgroundColor:this.state.privacidad === ''+(this.state.politicas.length-1)?COLOR.verde:COLOR.gris,alignSelf:'center'}} onPress={() => {this.setState({isVisiblePrivacidad: false, privacidad:''+(this.state.politicas.length-1)})}}>
